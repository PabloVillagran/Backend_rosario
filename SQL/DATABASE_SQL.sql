...
CREATE TABLE IF NOT EXISTS curso_materia (
  ...
  CONSTRAINT curso_materia_ibfk_4 FOREIGN KEY (ID_PROFESOR) REFERENCES usuario (ID_USUARIO) 
) ;
...
CREATE TABLE IF NOT EXISTS matricula (
  ...
  CONSTRAINT matricula_ibfk_1 FOREIGN KEY (ID_ALUMNO) REFERENCES usuario (ID_USUARIO)
) ;
